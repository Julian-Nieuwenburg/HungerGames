...
public class InventorySlot : MonoBehaviour,IPointerEnterHandler 
{
    ...
    [Tooltip("Change this to alter the normal and selected apperance of the inventory slot")]public Sprite baseSoltImage, activeSlotImage;
    ...
    [HideInInspector]public Inventory owningInventory;
